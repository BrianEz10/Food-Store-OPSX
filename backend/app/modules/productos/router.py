...
from app.modules.productos.schemas import DisponibilidadRequest, ImagenProductoUpdate, IngredienteEnProductoRequest, ProductoCreate, ProductoDetail, ProductoIngredienteRead, ProductoUpdate, ProductoOut, PaginatedProductos
...
def obtener(id: int, svc: ProductoService = Depends(get_producto_service)) -> ProductoDetail:
