...
try:
    req = Request(f"{BASE}/auth/login", data=json.dumps({"email":"admin@gmail.com","password":"Admin12345"}).encode(),
                  headers={"Content-Type":"application/json"})
    with urlopen(req) as r:
...
if existing_prods and existing_prods["total"] > 15:
    ...
    def ing(n): return {"ingrediente_id":ings[n],"cantidad":1}

    products = [
        ("Agua Mineral sin gas","Agua mineral natural sin gas 500ml",850,"Agua Mineral sin gas",["Aguas"],[ing("Agua")]),
        ("Agua con gas","Agua mineral natural con gas 500ml",950,"Agua con gas",["Aguas"],[ing("Agua"),ing("Gas")]),
        ("Coca Cola","Gaseosa cola 500ml",1200,"Coca Cola",["Gaseosas"],[ing("Agua"),ing("Azúcar")]),
        ("Sprite","Gaseosa lima-limón 500ml",1200,"Sprite",["Gaseosas"],[ing("Agua"),ing("Limón")]),
        ("Jugo de naranja natural","Jugo de naranja natural 400ml",1500,"Jugo de naranja natural",["Jugos"],[ing("Naranja")]),
        ("Jugo natural de limón","Jugo de limón natural 400ml",1300,"Jugo natural de limon",["Jugos"],[ing("Limón")]),
        ("Maní salado","Maní salado tostado 100g",600,"Mani salado",["Bebidas"],[ing("Maní")]),
        ("Lasaña clásica","Lasaña de carne con salsa bechamel, queso y jamón",4200,"Lasaña clasica",["Pastas"],[ing("Harina de trigo"),ing("Carne picada"),ing("Queso"),ing("Salsa bechamel"),ing("Salsa de tomate")]),
        ("Ravioles de ricota","Ravioles artesanales de ricota y espinaca",3800,"Ravioles de ricota",["Pastas"],[ing("Harina de trigo"),ing("Ricota"),ing("Espinaca"),ing("Huevo")]),
        ("Tallarines a la bolognesa","Tallarines frescos con salsa bolognesa",3500,"Tallarines a la bolognesa",["Pastas"],[ing("Harina de trigo"),ing("Salsa bolognesa"),ing("Parmesano")]),
        ("Bife de chorizo","Bife de chorizo 300g con guarnición",5800,"Bife de chorizo",["Carnes"],[ing("Carne picada"),ing("Cebolla")]),
        ("Pollo a la parrilla","Pechuga de pollo a la parrilla con vegetales",4200,"Pollo a la parilla",["Carnes"],[ing("Pollo"),ing("Lechuga"),ing("Tomate")]),
        ("Ensalada mixta","Lechuga, tomate, cebolla y zanahoria",2200,"Ensalada mixta",["Ensaladas"],[ing("Lechuga"),ing("Tomate"),ing("Cebolla")]),
        ("Ensalada César","Lechuga, pollo, croutons y parmesano",3200,"Ensalada Cesar",["Ensaladas"],[ing("Lechuga"),ing("Pollo"),ing("Parmesano")]),
        ("Bowl de palta","Bowl veggie con palta, quinoa y vegetales",2800,"Bowl de palta",["Ensaladas"],[ing("Palta"),ing("Tomate"),ing("Limón")]),
        ("Brownie de chocolate","Brownie de chocolate amargo con nueces",1800,"Brownie de chocolate",["Postres"],[ing("Cacao"),ing("Huevo"),ing("Manteca"),ing("Harina de trigo")]),
        ("Flan casero","Flan casero con dulce de leche",1500,"Flan casero",["Postres"],[ing("Leche"),ing("Huevo")]),
        ("Helado de frutilla","Helado artesanal de frutilla 2 bochas",1200,"Helado de frutilla",["Postres"],[ing("Frutilla"),ing("Leche"),ing("Crema de leche")]),
    ]
...
test_users = [
    ...
    ("cocina@test.com", "Test1234!", "Cocina", "Test", ["COCINA"]),
]
...
print(f"\nUsuarios de prueba:")
print(f"  Admin:  admin@gmail.com / Admin12345")
