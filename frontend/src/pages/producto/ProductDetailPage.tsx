  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="aspect-[4/3] rounded-xl bg-gray-200 dark:bg-gray-700" />
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 h-10 w-1/3 rounded bg-gray-200 dark:bg-gray-700" />
        </div>
      </div>
    </div>
  );
...
<p className="text-sm text-gray-500 dark:text-gray-400">
  ...
  if (!product) {
    return (
      <div className="mx-auto max-w-4xl">
        <div className="flex flex-col items-center justify-center gap-4 py-16 text-center">
          <AlertTriangle className="size-12 text-gray-300 dark:text-gray-600" />
          <div>
<p className="text-lg font-medium text-gray-700 dark:text-gray-300">
...
<p className="text-sm text-gray-500 dark:text-gray-400">
  ...
  const handleAddToCart = () => {
    addItem({
      ...
      cantidad: 1,
      imagenUrl: getProductImage(product.nombre, product.imagen_url) || '',
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {/* Product image */}
        <div className="aspect-[4/3] overflow-hidden rounded-card bg-gray-100 dark:bg-gray-800">
          {(() => {
        ...
        {/* Product info */}
        <div className="flex flex-col gap-4">
          <h1 className="text-2xl font-bold font-display text-on-surface dark:text-gray-100">
            {nombre}
          </h1>
          ...
          {descripcion && (
            <div>
              <h2 className="mb-1 text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">
                Descripción
              </h2>
          ...
          {ingredientes && ingredientes.length > 0 && (
            <div>
              <h2 className="mb-2 text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">
                Ingredientes
              </h2>
              ...
              <div className="space-y-1.5">
                {ingredientes
                  ...
                  .map((ing) => (
                    <label
                      key={ing.id}
                      className="flex cursor-pointer items-center gap-2 rounded-card border border-outline/10 px-3 py-2 text-sm transition-colors hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-800"
                    >
                      <input
                        type="checkbox"
