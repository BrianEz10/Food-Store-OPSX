...
- **THEN** se muestra un indicador "Sin: <ingrediente1>, <ingrediente2>" debajo del nombre del producto
...
- **THEN** se muestra: lista completa de items (imagen, nombre, descripción breve, precio unitario, cantidad con controles +/-, exclusiones, subtotal), total general, y botón "Proceder al checkout"
